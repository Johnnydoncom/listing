<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/news')) }}" href="{{ route('admin.news.index') }}">
                    <i class="nav-icon icon-paper"></i> All News
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/news')) }}" href="{{ route('admin.news.index') }}">
                    <i class="nav-icon icon-speedometer"></i> News Category
                </a>
            </li>
            <li class="nav-title">
                Manage Listing
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/listing')) }}" href="{{ route('admin.listing.index') }}">
                    <i class="nav-icon icon-speedometer"></i> All Listing
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/listing/create')) }}" href="{{ route('admin.listing.create') }}">
                    <i class="nav-icon icon-speedometer"></i> Add New Listing
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/make')) }}" href="{{ route('admin.make.index') }}">
                    <i class="nav-icon icon-speedometer"></i> Makes
                </a>
            </li>
