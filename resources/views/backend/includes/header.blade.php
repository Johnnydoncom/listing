<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo2.png') }}" width="89" height="25" alt="{{ app_name() }}">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/logo2.png') }}" width="30" height="30" alt="{{ app_name() }}">
    </a>
