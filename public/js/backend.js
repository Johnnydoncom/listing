...
/* harmony default export */ __webpack_exports__["default"] = ({
				...
				methods: {
								getCategories: function getCategories() {
												...
												window.axios.get('/admin/category').then(function (response) {
								...
								getMakes: function getMakes() {
												...
												window.axios.get('/admin/make').then(function (response) {
								...
								getModels: function getModels() {
												...
												this.models = "";
												window.axios.get('/admin/make/' + this.listing.make).then(function (response) {
																_this3.models = response.data;
												});
								},
								formSubmit: function formSubmit(e) {
												window.axios.post('/admin/listing', this.listing).then(function (response) {
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/backend/components/EditListingComponent.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
				...
				methods: {
								...
								formSubmit: function formSubmit(e) {
												...
												window.axios.put('/admin/listing/' + this.slisting.id, this.listing).then(function (response) {
																_this4.success = true;
												}).catch(function (error) {
								...
								processApproval: function processApproval() {
												var _this5 = this;

												window.axios.post('/admin/listing/approval', { listing_id: this.slisting.id }).then(function (response) {
																_this5.listing.approved = response.data.approved;
...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/backend/components/ExampleComponent.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2cc7cb23\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/ExampleComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2cc7cb23", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5b85ed1a\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/EditListingComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
              ...
              _c("div", { staticClass: "card-body" }, [
                ...
                _c(
                  "button",
                  {
                    ...
                    class:
                      _vm.listing.approved == "1"
                        ? "btn-success"
                        : "btn-danger",
                    on: { click: _vm.processApproval }
                  },
                  [
                    _vm._v(
                      _vm._s(
                        _vm.listing.approved == 1 ? "Approved" : "Disapproved"
                      )
                    )
                  ]
                )
          ...
          _c("div", { staticClass: "card" }, [
            _c("div", { staticClass: "card-body" }, [
              _c("div", { staticClass: "form-group mt-4 border-bottom" }, [
                _c("label", { staticClass: "h4" }, [_vm._v("Category")]),
                _vm._v(" "),
                _c(
                  "select",
                  {
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group mt-4 border-bottom" }, [
                _c("label", { staticClass: "h4" }, [_vm._v("Make")]),
                _vm._v(" "),
                _c(
                  "select",
                  {
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group mt-4 border-bottom" }, [
                _c("label", { staticClass: "h4" }, [_vm._v("Model")]),
                _vm._v(" "),
                _c(
                  "select",
                  {
              ...
              _vm._v(" "),
              _c("div", { staticClass: "form-group mt-4 border-bottom" }, [
                _c("label", { staticClass: "h4" }, [_vm._v("Featured Image")]),
                _vm._v(" "),
                _c("input", {
                  staticClass: "form-control",
                  attrs: { type: "file" },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("drivetrain")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "text", name: "" }
  ...
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("No of Gears")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
      ...
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("No of Air-Bag")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "number", name: "" }
      ...
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("Fuel Type")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "text", name: "" }
  ...
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("Interior Color")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "text", name: "" }
      ...
      _c("div", { staticClass: "col" }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "" } }, [_vm._v("Exterior Color")]),
          _vm._v(" "),
          _c("input", {
            staticClass: "form-control",
            attrs: { type: "text", name: "" }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5b85ed1a", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-f0ac3e4c\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/AddListingComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f0ac3e4c", module.exports)
  }
}
...
/***/ "./resources/js/backend/components/AddListingComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-f0ac3e4c\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/AddListingComponent.vue")
/* template functional */
...
Component.options.__file = "resources\\js\\backend\\components\\AddListingComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f0ac3e4c", Component.options)
  } else {
    hotAPI.reload("data-v-f0ac3e4c", Component.options)
  }
...
/***/ "./resources/js/backend/components/EditListingComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/backend/components/EditListingComponent.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5b85ed1a\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/EditListingComponent.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
Component.options.__file = "resources\\js\\backend\\components\\EditListingComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5b85ed1a", Component.options)
  } else {
    hotAPI.reload("data-v-5b85ed1a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/***/ "./resources/js/backend/components/ExampleComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/backend/components/ExampleComponent.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-2cc7cb23\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/backend/components/ExampleComponent.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
Component.options.__file = "resources\\js\\backend\\components\\ExampleComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2cc7cb23", Component.options)
  } else {
    hotAPI.reload("data-v-2cc7cb23", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component('example-component', __webpack_require__("./resources/js/backend/components/ExampleComponent.vue"));
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component('addlisting-component', __webpack_require__("./resources/js/backend/components/AddListingComponent.vue"));
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component('editlisting-component', __webpack_require__("./resources/js/backend/components/EditListingComponent.vue"));
...
module.exports = __webpack_require__("./resources/js/backend/script.js");
